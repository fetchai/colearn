...
_RESPONSESUPPORTEDSYSTEM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='models', full_name='contract_learn.grpc.ResponseSupportedSystem.models', index=1,
...
_RESPONSESUPPORTEDSYSTEM.fields_by_name['models'].message_type = _MODELARCHSPEC
